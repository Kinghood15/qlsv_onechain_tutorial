                ...
                {(() => {
                    if (isUserTeacher !== null) {
                        ...
                        return (
                            <>
                                {/* <button href="/notification" className="w-12 h-12 flex m-2 items-center justify-center bg-white rounded-full hover:text-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500 drop-shadow-md"><MdNotifications size={28} /></button> */}
                                <button onClick={() => navigate('/giao-vien/dang-ky-2')} className={`${isMobile ? (isMobile480 ? (isMobile380 ? 'w-[50%] h-5 text-[7px]' : 'w-[50%] h-10 text-[9px]') : 'w-20 h-10 text-[10px]' ) : 'w-40 h-12'} flex m-2 items-center justify-center bg-white rounded-full hover:text-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500`}>Đăng ký giáo viên</button>
                                <button onClick={() => navigate('/giao-vien/dang-nhap')} className={`${isMobile ? (isMobile480 ? (isMobile380 ? 'w-[50%] h-5 text-[7px]' : 'w-[50%] h-10 text-[9px]') : 'w-20 h-10 text-[10px]' ) : 'w-40 h-12'} flex m-2 items-center justify-center bg-white rounded-full hover:text-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500`}>Đăng nhập giáo viên</button>
                            </>
                        )
                    }
                })()}
